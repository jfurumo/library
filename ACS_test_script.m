...
SC_ATT_Q1 = 0.089439235;
SC_ATT_Q2 = 0.136739969;
SC_ATT_Q3 =-0.843088052;
SC_ATT_Q4 = 0.512352751;

sc_att_quat = [SC_ATT_Q1,SC_ATT_Q2,SC_ATT_Q3,SC_ATT_Q4];

sc_att_rm = Q2A(sc_att_quat)

sc_att_euler = quat2Euler(sc_att_quat)
